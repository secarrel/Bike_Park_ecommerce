...
# Add a notes section in the model above which will translate to be 'Description' in the 'modal' of scheduler.
...
#             title=instance.title,  # Adjust these fields based on your Timeslot model
